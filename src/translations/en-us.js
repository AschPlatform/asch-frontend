...
window.Translations['en-us'] = {
  ...
  CONFIRM: 'Confirm',
  CANCEL: 'Cancel',
  LOGIN_TIP_LINE1: 'Our system has generated a safty password',
  LOGIN_TIP_LINE2: 'next you will required to type it in the box',
  LOGIN_TIP_LINE3: 'Please type your password',
  LOGIN_TIP_LINE4: 'Please be sure having keeping your password',
  LOGIN_TIP_LINE5: 'otherwise your will lost all your coin permanently',
  LOGIN_ADD_ADDRESS: 'Add',
  LOGIN_REMOVE_ADDRESS: 'Remove',
  ...
  PASSWORD: 'Secret',
  SUBMIT_SECOND_PASSWORD_TIP1: 'Make sure you have saved your second secret in a safe place.If you lost it, you will not be able',
  SUBMIT_SECOND_PASSWORD_TIP2: 'to recover your assets in Asch system. You will be charged in XAS when you reset the second password.',
  SUBMIT: 'Submit',
